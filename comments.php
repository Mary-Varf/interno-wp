...
function comment_form_default_add_phone_field( $fields ) {
    ...
    $fields['phone'] = '<input id="phone" class="contact-form__input" placeholder="Phone" name="phone" type="text" size="30"/>';
...
$fields   =  array(
    ...
    'email'  => '<input id="email" name="email" class="contact-form__input" placeholder="Email"' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $html_req  . ' />',

    'url'    => '<input id="url" name="url"  class="contact-form__input" placeholder="Website" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" maxlength="200" />',
    ...
    'phone' => '<input id="phone" name="phone"  class="contact-form__input" placeholder="Phone" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_phone'] ) . '" size="30" maxlength="200" />',
);
$args = array(
    'comment_field' => '<textarea id="comment" name="comment" aria-required="true" class="contact-form__textarea" placeholder="Hello Iam Intrested in.."></textarea>',
    ...
    'submit_field' => '<div class="contact-form__btn">%1$s %2$s</div>',
