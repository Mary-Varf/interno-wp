            ...
            <div class="contact__info">
                <ul class="contact-list">
                    <li class="contact-list__item contact-list__email">
                        <a class="contact-list__link" href="mailto:<?php the_field('email_', 8) ?>"><?php the_field('email_', 8) ?></a>
                    </li>
                    <li class="contact-list__item contact-list__tel">
                        <a class="contact-list__link" href="tel:<?php echo CLEAN_PHONE; ?>"><?php the_field('phone', 8) ?></a>
                    </li>
                    <li class="contact-list__item contact-list__website">
                        <a class="contact-list__link" href="<?php the_field('web_site_', 8) ?>"><?php the_field('web_site_', 8) ?></a>
                    </li>
                </ul>
