...
<div class="thumb">
    <img class="thumb__img" src="<?php echo INTERNO_IMG_DIR ?>/bg-post.jpg" alt="">
</div>
<div class="page">
    <div class="container">
        <div class="content">
            <div class="post">
                <article class="main-article">
                    ...
                    <span class="main-article__date"><?php echo get_the_date('j F, Y'); ?></span>
                ...
                <div class="comments post__comments">
                    ...
                    <form class="contact-form post__form">
                        ...
                        <div class="contact-form__checkbox">
                            <input type="checkbox" id="saveData" class="checkbox">
                            <label for="saveData">Save my name, email, and website in this browser for the next time I comment.</label>
                        </div>
